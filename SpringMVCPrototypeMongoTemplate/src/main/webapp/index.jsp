...
<html>
	...
	<body>
		<nav class="navbar navbar-expand-sm bg-dark">
		  <ul class="navbar-nav">
		    <li class="nav-item">
		      <a id="secure" href="${pageContext.servletContext.contextPath}/stores">Search for Supplies</a>
		    </li>
		  </ul>
		</nav>
    ...
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li><a href="${pageContext.servletContext.contextPath}/stores"><i class="bx bx-user"></i> <span>About</span></a></li>
